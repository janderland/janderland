...
[configurable subspace]: https://github.com/janderland/fdb-mutex/blob/main/mutex.go#L25
...
tests for each query, it becomes easy to avoid schema drift
in different parts of the implementation. Once again,
