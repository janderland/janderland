...
> This article uses features of FQL (the query language)
...
a running transaction. This allows the application to run
queries in isolation, or compose multiple queries into
...
func (x *kv) getOwner(db fdb.Transactor) (owner, error) 
